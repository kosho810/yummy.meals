...
async function getHome() {
  ...
  <input id="searchByName" type="text" class="form-control form-search m-4" placeholder="Search By Name">
  <input id="searchByFL" type="text" class="form-control form-search m-4" placeholder="Search By First Letter">
  </div>`
  ...
  <button id="formSubmitBtn" class="btn mt-3" disabled>Submit</button> 
  `
